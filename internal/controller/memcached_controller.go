...
import (
	...
	cachev1alpha1 "github.com/etirelli/memcached-operator/api/v1alpha1"
)

const memcachedFinalizer = "cache.edsontirelli/finalizer"
...
//+kubebuilder:rbac:groups=cache.edsontirelli,resources=memcacheds,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=cache.edsontirelli,resources=memcacheds/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=cache.edsontirelli,resources=memcacheds/finalizers,verbs=update
